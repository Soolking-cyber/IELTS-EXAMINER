...
export class GdmLiveAudioVisuals extends LitElement {
  ...
  // FIX: LitElement lifecycle methods must be protected to override base class.
  ...
  // FIX: The 'render' method must be protected to override the base class method in LitElement.
  protected render() {
